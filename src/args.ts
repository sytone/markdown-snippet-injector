...
export type ProgramOptions = {
  ...
  wrap: boolean;
  useOsEol: boolean;
  addAutoGeneratedFooter: boolean;
...
export default async function args(cmd: string[]): Promise<ProgramOptions> {
  return yargs(hideBin(cmd))
    ...
    .option('add-auto-generated-footer', {
      description: 'Adds a footer to the updated/gnerated files with the date and time of the update.',
      type: 'boolean',
      default: false,
    })
    .strict().argv;
